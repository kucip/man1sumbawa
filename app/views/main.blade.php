...
<body>
   ...
   <!--====== PRELOADER PART START ======-->
                                ...
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item">
                                        <a href="about.html">Profil</a>
                                         <ul class="sub-menu">
                                            <li><a class="active" href="index-2.html">Sambutan</a></li>
                                            <li><a href="index-3.html">Visi dan misi</a></li>
                                            <li><a href="index-4.html">Sejarah Singkat</a></li>
    ...
    <section id="slider-part" class="slider-active">
        <div class="single-slider slider-2 bg_cover" width="40%" height="50%" style="background-image: url(images/slider/s-5.jpg)" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-7 col-lg-10">
                        <div class="slider-cont">
                            <h1 data-animation="bounceInLeft" data-delay="1s" font="8">Lebih dari ratusan siswa menggapai mimpinya disini</h1>
                            <a data-animation="fadeInUp" data-delay="1s" href="#" class="main-btn">Mari bergabung dengan Kami</a>
                        </div>
                    </div>
                </div> <!-- row -->
            </div> <!-- container -->
        ...
        <div class="single-slider slider-2 bg_cover" style="background-image: url(images/slider/s-4.png)" data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-9 col-lg-10">
                        <div class="slider-cont">
                            <h1 data-animation="bounceInLeft" data-delay="1s">Lebih dari ratusan siswa menggapai mimpinya disini</h1>
                            <a data-animation="fadeInUp" data-delay="1.3s" href="#" class="main-btn">Mari bergabung dengan Kami</a>
                        </div>
                    </div>
                </div> <!-- row -->
            </div> <!-- container -->
                    ...
                    <div class="category-2-items pt-10">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="{{url('/public')}}/assets/images/category/ctg-1.jpg" alt="Category">
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="{{url('/public')}}/assets/images/category/ctg-2.jpg" alt="Category">
                                    </div>
                                    <div class="items-cont">
                                        <a href="#">
                            ...
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="{{url('/public')}}/assets/images/category/ctg-3.jpg" alt="Category">
                                    </div>
                                    <div class="items-cont">
                                        <a href="#">
                                            <h5>UI/ UX Design</h5>
                            ...
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="{{url('/public')}}/assets/images/category/ctg-4.jpg" alt="Category">
                                    </div>
                                    <div class="items-cont">
                                        <a href="#">
                                            <h5>Photography</h5>
                            ...
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="{{url('/public')}}/assets/images/category/ctg-5.jpg" alt="Category">
                                    </div>
                                    <div class="items-cont">
                                        <a href="#">
                                            <h5>Finance</h5>
                            ...
                            <div class="col-md-6">
                                <div class="singel-items text-center mt-30">
                                    <div class="items-image">
                                        <img src="{{url('/public')}}/assets/images/category/ctg-6.jpg" alt="Category">
                                    </div>
                                    <div class="items-cont">
                                        <a href="#">
                                            <h5>Science</h5>
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="category-form">
                        <div class="form-title text-center">
                            <h3>Segera Daftarkan Putra Putri Anda!</h3>
            ...
            <div class="row course-slied mt-30">
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="{{url('/public')}}/assets/images/course/cu-1.jpg" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="courses-singel.html"><img src="{{url('/public')}}/assets/images/course/teacher/t-1.jpg" alt="teacher"></a>
                                </div>
                                <div class="name">
                ...
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="{{url('/public')}}/assets/images/course/cu-2.jpg" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="courses-singel.html"><img src="{{url('/public')}}/assets/images/course/teacher/t-2.jpg" alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="#"><h6>Mark anthem</h6></a>
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="{{url('/public')}}/assets/images/course/cu-3.jpg" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="courses-singel.html"><img src="{{url('/public')}}/assets/images/course/teacher/t-3.jpg" alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="#"><h6>Mark anthem</h6></a>
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="{{url('/public')}}/assets/images/course/cu-4.jpg" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="courses-singel.html"><img src="{{url('/public')}}/assets/images/course/teacher/t-4.jpg" alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="#"><h6>Mark anthem</h6></a>
                                </div>
                ...
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="{{url('/public')}}/assets/images/course/cu-5.jpg" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="courses-singel.html"><img src="{{url('/public')}}/assets/images/course/teacher/t-5.jpg" alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="#"><h6>Mark anthem</h6></a>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="teachers-2-singel mt-30">
                                    <div class="thum">
                                        <img src="{{url('/public')}}/assets/images/teachers/teacher-2/tc-1.jpg" alt="Teacher">
                                    </div>
                                    <div class="cont">
                            ...
                            <div class="col-md-6">
                                <div class="teachers-2-singel mt-30">
                                    <div class="thum">
                                        <img src="{{url('/public')}}/assets/images/teachers/teacher-2/tc-2.jpg" alt="Teacher">
                                    </div>
                                    <div class="cont">
                    ...
                    <div class="happy-student mt-55">
                        ...
                        <div class="student-slied">
                            <div class="singel-student">
                                <img src="{{url('/public')}}/assets/images/teachers/teacher-2/quote.png" alt="Quote">
                        ...
                        <div class="student-image">
                            <img src="{{url('/public')}}/assets/images/teachers/teacher-2/happy.png" alt="Image">
                        </div>
                    </div> <!-- happy student -->
                </div>
            </div> <!-- row -->
                ...
                <div class="col-lg-6">
                    <div class="singel-news mt-30">
                        <div class="news-thum pb-25">
                            <img src="{{url('/public')}}/assets/images/news/n-1.jpg" alt="News">
                        </div>
                        <div class="news-cont">
                            <ul>
                ...
                <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="news-thum mt-30">
                                    <img src="{{url('/public')}}/assets/images/news/ns-1.jpg" alt="News">
                                </div>
                            </div>
                            <div class="col-sm-8">
                    ...
                    <div class="singel-news news-list">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="news-thum mt-30">
                                    <img src="{{url('/public')}}/assets/images/news/ns-2.jpg" alt="News">
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="news-cont mt-30">
                    ...
                    <div class="singel-news news-list">
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="news-thum mt-30">
                                    <img src="{{url('/public')}}/assets/images/news/ns-3.jpg" alt="News">
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="news-cont mt-30">
            ...
            <div class="row patnar-slied">
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                        <img src="{{url('/public')}}/assets/images/patnar-logo/p-1.png" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                        <img src="{{url('/public')}}/assets/images/patnar-logo/p-2.png" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                        <img src="{{url('/public')}}/assets/images/patnar-logo/p-3.png" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
                        <img src="{{url('/public')}}/assets/images/patnar-logo/p-4.png" alt="Logo">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="singel-patnar text-center mt-40">
