...
<head>
	...
	<!-- Theme JS files -->
	<script type="text/javascript" src="{{url('/public')}}/assets/js/plugins/visualization/d3/d3.min.js"></script>
	<script type="text/javascript" src="{{url('/public')}}/assets/js/plugins/visualization/d3/d3_tooltip.js"></script>
	<script type="text/javascript" src="{{url('/public')}}/assets/js/plugins/forms/styling/switchery.min.js"></script>
	<script type="text/javascript" src="{{url('/public')}}/assets/js/plugins/forms/styling/uniform.min.js"></script>
	<script type="text/javascript" src="{{url('/public')}}/assets/js/plugins/forms/selects/bootstrap_multiselect.js"></script>
	<script type="text/javascript" src="{{url('/public')}}/assets/js/plugins/ui/moment/moment.min.js"></script>
	<script type="text/javascript" src="{{url('/public')}}/assets/js/plugins/pickers/daterangepicker.js"></script>
...
<body>
				...
				<li class="dropdown">
					...
					<div class="dropdown-menu dropdown-content">
						...
						<ul class="media-list dropdown-content-body width-300">
							<li class="media">
								<div class="media-left"><img src="{{url('/public')}}/assets/images/placeholder.jpg" class="img-circle img-sm" alt=""></div>
								<div class="media-body">
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown language-switch">
					...
					<ul class="dropdown-menu">
						<li><a class="deutsch"><img src="{{url('/public')}}/assets/images/flags/de.png" alt=""> Deutsch</a></li>
						<li><a class="ukrainian"><img src="{{url('/public')}}/assets/images/flags/ua.png" alt=""> Українська</a></li>
						<li><a class="english"><img src="{{url('/public')}}/assets/images/flags/gb.png" alt=""> English</a></li>
						<li><a class="espana"><img src="{{url('/public')}}/assets/images/flags/es.png" alt=""> España</a></li>
						<li><a class="russian"><img src="{{url('/public')}}/assets/images/flags/ru.png" alt=""> Русский</a></li>
					</ul>
				</li>
				...
				<li class="dropdown dropdown-user">
					<a class="dropdown-toggle" data-toggle="dropdown">
						<img src="{{url('/public')}}/assets/images/placeholder.jpg" alt="">
						<span>{{$namelong}}</span>
						<i class="caret"></i>
					</a>
		...
		<div class="navbar-collapse collapse" id="navbar-second-toggle">
			<ul class="nav navbar-nav">
				...
				@foreach($menu as $val)
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							<i class="{{$val['menuIcon']}} position-left"></i> {{$val['menuName']}} <span class="caret"></span>
						</a>

						 @if(count($val['data'])>0)
							<ul class="dropdown-menu width-200">
					 		@foreach($val['data'] as $val2)
								@if(count($val2['data'])>0)
									<li class="dropdown-submenu">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="{{$val2['menuIcon']}}"></i> {{$val2['menuName']}}</a>
										<ul class="dropdown-menu">
									 		@foreach($val2['data'] as $val3)
												<li><a href="{{$val3['menuLink']}}">{{$val3['menuName']}}</a></li>
											@endforeach
										</ul>
									</li>
								@else
									<li><a href="{{$val2['menuLink']}}"><i class="{{$val2['menuIcon']}}"></i> {{$val2['menuName']}}</a></li>
								@endif
							@endforeach
							</ul>
						 @endif
		...
		<div class="page-header-content">
			<div class="page-title">
				<h4>
					...
					<small class="display-block">Welcome {{$namelong}}!</small>
				</h4>
			</div>
	...
	<div class="page-container">
		...
		<div class="footer text-muted">
			&copy; 2019. <a href="#">Optima Web Template</a> by <a href="#" target="_blank">kucip</a>
		</div>
	</div>
</body>
</html>
